...
class ItemListAdapterNew(var context: Context, var itemList: MutableList<Item>) :
    Adapter<ItemListAdapterNew.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.recyclerItem.setOnClickListener {
            context.startActivity(Intent(context, ItemDetailsActivity::class.java).apply {
                putExtra("ITEM", item)
            })
        }
